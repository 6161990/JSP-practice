...
<%
	...
	//만약 처음 boardList.jsp 를 클릭하거나 수정, 삭제 등 다른 게시글에서 이 페이지로 넘어오면 pageNum값이 없기에 null 처리를 해주어야함
	//pageNum 이 넘어오지 않았다는 것은 최신글을 보여달라는 것
	if(pageNum==null){
		pageNum="1";
	}
...
<table width="700" border="5" bordercolor="#00BCD4" bgcolor="#E0F7FA">
	<tr height = "40">
	...
	<%
		for(int i=0; i<vec.size(); i++){
			BoardBean bean = vec.get(i); //벤터에 저장되어 있는 빈클래스를 하나씩 추출
